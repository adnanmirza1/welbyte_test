class SessionsController < ApplicationController
  ...
  def set_time_zone
    params[:session][:start_time] = params[:session][:start_time].to_time + params[:session][:timezone].to_i.minutes
    params[:session][:end_time] = params[:session][:end_time].to_time + params[:session][:timezone].to_i.minutes
  end
end
